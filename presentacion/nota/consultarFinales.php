...
<?php if ($_SESSION["rol"] == "docente") {
    ...
    $notas = $nota->consultarPorPagina($cantidad, $pagina, $orden, $dir, $_GET["materia"], $_GET["grupo"]);
    $totalRegistros = $nota->consultarTotalRegistros($_GET["materia"], $_GET["grupo"]);
    echo $totalRegistros;
...
<div class="container-fluid row justify-content-center">
    ...
    foreach ($notas as $notaActual) {
            ...
            echo "<td>" . $materia->getNombre() . "</td>"; 
                echo "<td>" . $notaActual->getCodigo_FK() . "</td>";
            $alumno = new Alumno($notaActual->getCodigo_FK());
            $alumno -> consultar();
