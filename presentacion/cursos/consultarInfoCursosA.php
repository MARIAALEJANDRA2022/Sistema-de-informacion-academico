...
<div class="container-fluid row justify-content-center">
    ...
    foreach ($horarios as $horarioActual) {
        ...
        $docente = new Docente($materia->getID_Docente());
        $docente->consultarNombre();
        ...
        echo "</td>";
        echo "<td>";
        echo "<a href='index.php?pid=" . base64_encode("presentacion/cursos/verDocente.php") . "&idDocente=" . $docente->getCodigo() . "'><i class='fas fa-chalkboard-teacher' data-toggle='tooltip' data-placement='bottom' title='Ver docente'></i></a>&nbsp";
        echo "</tr>";
    }
    ?>											
    						</tbody>
    ...
    if ($pagina == 1) {
        ...
        echo "<li class='page-item'><a class='page-link' href='index.php?pid=" . base64_encode("presentacion/cursos/consultarInfoCursosA.php") . "&pagina=" . ($pagina - 1) . "&cantidad=" . $cantidad . (($orden != "") ? "&orden=" . $orden : "") . (($dir != "") ? "&dir=" . $dir : "") . "'>Anterior</a></li>";
    }
            ...
            if ($pagina == $i) {
                ...
                if ($pagina != 1 && $i == $pagina - 2 || $pagina != 1 && $i == $pagina + 2) {
                    if ($i == 1 || $i == $totalPaginas) {
                        echo "<li class='page-item'><a class='page-link' href='index.php?pid=" . base64_encode("presentacion/cursos/consultarInfoCursosA.php") . "&pagina=" . $i . "&cantidad=" . $cantidad . (($orden != "") ? "&orden=" . $orden : "") . (($dir != "") ? "&dir=" . $dir : "") . "'>" . $i . "</a></li>";
                    } else {
                        echo "...";
                    }
                } else {
    ...
    if ($pagina == $totalPaginas || $totalRegistros == 0) {
        ...
        echo "<li class='page-item'><a class='page-link' href='index.php?pid=" . base64_encode("presentacion/cursos/consultarInfoCursosA.php") . "&pagina=" . ($pagina + 1) . "&cantidad=" . $cantidad . (($orden != "") ? "&orden=" . $orden : "") . (($dir != "") ? "&dir=" . $dir : "") . "'>Siguiente</a></li>";
    }
    ?>
    								</ul>
							</nav>
...
<script>
    $("#cantidad").on("change", function() {
    	url = "index.php?pid=<?php echo base64_encode("presentacion/cursos/consultarInfoCursosA.php") ?>&cantidad=" + $(this).val() + "<?php echo (($orden!="")?"&orden=" . $orden:"") . (($dir!="")?"&dir=" . $dir:"") ?>";
    	//alert (url);
...
<div class="container-fluid row justify-content-center">
    ...
    foreach ($horarios as $horarioActual) {
        ...
        echo "<td>" . $horarioActual->getDia() . "</td>";
        echo "<td>" . $horarioActual->getHora_ini() . "</td><td>" . $horarioActual->getHora_fin() . "</td>";
        echo "</tr>";
    }
    ?>											
    						</tbody>
